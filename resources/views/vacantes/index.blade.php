                    ...
                    <tr>
                        <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    <div class="text-sm leading-5 font-medium text-gray-900">{{ $vacante->titulo }}
                                    </div>
                        ...
                        <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                            <span
                                class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full {{ $vacante->condicion === 'activa' ? 'bg-green-300 text-green-800':'bg-red-300 text-red-800' }}">
                                {{ $vacante->condicion }}
                            </span>
                        </td>
                        <td

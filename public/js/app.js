    ...
    eliminarVacante: function eliminarVacante() {
      ...
      this.$swal.fire({
        ...
        if (result.value) {
          ...
          axios.post("/vacantes/destroy/".concat(_this.id), params).then(function (respuesta) {
            _this.$swal.fire('¡Vacante Eliminada!', respuesta.data.mensaje, 'success');
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    cambiarEstado: function cambiarEstado() {
      ...
      axios.post('/vacantes/' + this.id, params).then(function (respuesta) {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    ...
    if (this.oldskills) {
      ...
      skillsArray.forEach(function (element) {
        return _this.habilidades.add(element);
      });
    }
  },
  mounted: function mounted() {
  ...
  methods: {
    activar: function activar(e) {
      ...
      var string_habilidades = _toConsumableArray(this.habilidades);
...
Vue.component('list-skills', __webpack_require__(/*! ./components/ListaSkills.vue */ "./resources/js/components/ListaSkills.vue")["default"]);
